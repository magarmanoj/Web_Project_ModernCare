            ...
            <ion-card-content>
              <ion-card>
                <ion-card-content>
                  ...
                  <ion-item>
                    <ion-datetime label="Ontslag Datum" display-format="YYYY-MM-DD"
                      v-model="ontslagDatum"></ion-datetime>
                  </ion-item>
                  <ion-item>
                  ...
                  <ion-item>
                    <ion-select label="Verdieping" v-model="verdieping" @ionChange="updateKamerNummers">
                      <ion-select-option v-for="verdieping in uniqueVerdiepingen" :key="verdieping"
                        :value="verdieping">{{
          verdieping }}</ion-select-option>
                  ...
                  <ion-item>
                    <ion-select label="Kamer Nummer" v-model="kamerNummer">
                      <ion-select-option v-for="kamer in filteredKamers" :key="kamer.KamerNummer"
                        :value="kamer.KamerNummer">{{
